...
st.set_page_config(page_title='Weather App Dashboard', page_icon="img/page_icon.png", layout='wide', initial_sidebar_state='expanded')
...
st.sidebar.markdown(
            """
    ## Project Overview
    Weather App dashboard is an app that helps monitor current & future weather trends, situations across specified country/city...
    Get started already!""")    
